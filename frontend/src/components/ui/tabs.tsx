...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-11 items-center justify-center rounded-xl bg-secondary/70 p-1 text-muted-foreground backdrop-blur-sm border border-border/50",
      className
    )}
    {...props}
  />
